...
import numpy as np
import pandas as pd
from spectral_anomaly import load_configs, train_models
...
def main(argv=None):
    ...
    pipeline,splits=train_models(frame,cfg); result=pipeline.analyze(splits[2]); print(result[["atypicality_score","spot_anomaly","cluster_id"]].tail()); return result
